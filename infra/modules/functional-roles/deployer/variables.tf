...
variable "dbt_project_schema" {
  description = "Fully qualified names of the transformation schemas (STAGING/INTERMEDIATE/MARTS), e.g. values(module.source_setup.transformation_schemas_reference)[*].fully_qualified_name."
  type        = string
}
